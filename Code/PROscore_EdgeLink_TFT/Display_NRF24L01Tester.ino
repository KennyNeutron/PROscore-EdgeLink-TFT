...
void Display_NRF24L01Tester_PRE(void) {
  ...
  lv_obj_align(Label_PowerLevel, LV_ALIGN_TOP_LEFT, 10, 120);
  ...
  lv_obj_align(Label_Channel, LV_ALIGN_TOP_RIGHT, -10, 120);
  ...
  lv_obj_align(Label_DataRate, LV_ALIGN_TOP_MID, 0, 140);
